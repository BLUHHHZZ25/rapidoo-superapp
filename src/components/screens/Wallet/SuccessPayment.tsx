...
import { spacing, colors, sizes, text } from "../../../app/constants/theme";
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        <View style={{ width: "100%", height: 190}}>
                            <LottieView autoPlay loop={false} source={require('../../../app/assets/lotties/LottieTopUp.json')} style={{ width: 200, height: 200, alignSelf: 'center' }} />
                        </View>
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ alignSelf: 'center', paddingTop: spacing.s, width:"85%" }}>
                                <Text style={[text.mediumPlus, { height:50, color: colors.grayText, fontWeight: '700', textAlign:'center' }]}>Payment Successfully.</Text>
                                <Text style={[text.normal, styles.modalText, { color: colors.grayText, textAlign:'center',marginTop:spacing.s }]}>You have successfully topped up your wallet, and the funds are now available for use.</Text>
                            </View>
                        </View>
